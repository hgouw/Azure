...
namespace Azure.DbContexts
{
    public class Parser
    {
        ...
        public CaseDoc ParseXml()
        {
            ...
            XDocument doc = null;
            casedoc.FileNameUsedAsId = DateTime.Now.ToString("yyMMddHHmmss") + "xml";
        ...
        public CaseDoc ParseXml(string xml)
        {
            string sep = "|";
            CaseDoc casedoc = new CaseDoc();
        ...
        public CaseDoc ParseXml(string xml, string filename)
        {
            string sep = "|";
            CaseDoc casedoc = new CaseDoc();
            ...
            XDocument doc = null;
            casedoc.FileNameUsedAsId = filename;
